/**
 * HeadlessSkeleton - Headless adapter skeleton loader component
 * Pure Tailwind CSS implementation with multiple shapes
 */
      ...
      case 'card':
        return (
          <div
            ref={ref}
            data-testid={testId}
            className={cn('rounded-lg border dark:border-gray-700 p-4 space-y-4', className)}
...
HeadlessSkeleton.displayName = 'HeadlessSkeleton';
