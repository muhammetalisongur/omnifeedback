/**
 * HeadlessPopconfirm - Headless adapter popconfirm component
 * Pure Tailwind CSS implementation with positioning
 */
...
HeadlessPopconfirm.displayName = 'HeadlessPopconfirm';
